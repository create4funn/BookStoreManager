...
public class SuaTaiKhoan extends javax.swing.JDialog {
    ...
    public SuaTaiKhoan(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) {
        super(owner, modal);
        initComponents();
        setLocationRelativeTo(null);
        this.owner = (TaiKhoanForm) parent;
        TaiKhoan s = this.owner.getSelected();
        txtfullname.setText(s.getFullName());
        txtusername.setText(s.getTaiKhoan());
        txtusername.setEditable(false);
        txtpassword.setText(s.getMatKhau());
        cbRole.setSelectedItem(s.getRole());
    }

    private SuaTaiKhoan(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(cbRole, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 380, 298, 38));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 488, 140, 40));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
      ...
      String userName = txtusername.getText();
        ...
        TaiKhoan tk = new TaiKhoan(name, userName, pw, role);
        if (name.equals("")||pw.equals("")||role.equals("")) {
