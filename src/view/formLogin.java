...
public class formLogin extends javax.swing.JFrame {
    ...
    public void checkLogin() {
        ...
        if (usercheck.equals("") || passwordcheck.equals("")) {
            ...
            TaiKhoan acc = TaiKhoanDAO.getInstance().checkAccount(usercheck,passwordcheck);
            if (acc == null) {
                JOptionPane.showMessageDialog(this, "Sai tài khoản hoặc mật khẩu!", "Cảnh báo !", JOptionPane.WARNING_MESSAGE);
            } else {
