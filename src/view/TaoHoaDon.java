...
public class TaoHoaDon extends javax.swing.JDialog {
    ...
    public TaoHoaDon(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) {
        super(owner, modal);
        ...
        maHoaDon = Integer.parseInt(createId());
    ...
    private TaoHoaDon(JFrame jFrame, boolean b) {
    ...
    private void btnTaoHDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTaoHDActionPerformed
        ...
        if (cthd.isEmpty()) {
            ...
            if (check == JOptionPane.YES_OPTION) {
                ...
                HoaDon hoaDon = new HoaDon(maHoaDon, txtTenKH.getText(), sqlTimestamp, tinhTongTien(), cthd);
                try {
                    HoaDonDAO.getInstance().insert(hoaDon);
                    SachDAO sachDao = SachDAO.getInstance();
                    for (var i : cthd) {
                        ChiTietHoaDonDAO.getInstance().insert(i);
                        sachDao.updateSoLuong(i.getMaSach(), sachDao.selectById(i.getMaSach()).getSoLuong() - i.getSoLuong());
                    }
...
//                    textTongTien.setText(formatter.format(tinhTongTien()) + "đ");
    ...
    public ChiTietHoaDon findCTHD(int maS) {
